...
function MusicItem({ musicInfo }) {
    ...
    return (
        <div className="flex -mx-2 cursor-pointer" onClick={playOnClick}>
            <div className="w-full max-w-[185px] shrink-0 px-2">
                <div className="flex relative overflow-hidden rounded-lg">
                    ...
                    <div
                        className={`absolute inset-0 bg-black/50 flex justify-center items-center duration-200 ${
            ...
            <div className="w-full px-2 pt-1">
                ...
                <div className="flex gap-x-3 text-white/60">
